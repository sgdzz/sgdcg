        ...
        <div class="banner">
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                   <li><img src="${ctx }/files/slider_2.jpg" width="740" height="401" /></li>
                    <li><img src="${ctx }/files/slider_1.jpg" width="740" height="401" /></li>
                    <li><img src="${ctx }/files/slider_3.jpg" width="740" height="401" /></li>
                    <li><img src="${ctx }/files/slider_4.jpg" width="740" height="401" /></li>
                    <li><img src="${ctx }/files/slider_5.jpg" width="740" height="401" /></li>
                </ul>
