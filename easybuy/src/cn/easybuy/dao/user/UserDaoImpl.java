...
public class UserDaoImpl extends BaseDao implements UserDao {
	...
	public User findByPhone(String phone) throws Exception {
		String sql="SELECT  `id`,  `loginName`,  `userName`,  `password`,  `sex`,  `identityCode`,  `email`,  `mobile`,  `type` FROM easybuy_user WHERE mobile=?";
		pstm = connection.prepareStatement(sql);
		pstm.setString(1, phone);
		//ResultSet resultSet = this.executeQuery(sql,phone);
